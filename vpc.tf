...
# Below lines 35-38 show options used to obtain the reference values for a complex error message. 
# Used to populate the above complex error message.
...
#       List of supported AZs: ${data.aws_availability_zones.vavailable.names}
#       EOT
#     }
#   }
# }
